...
| Phase | 名称 | 周期 | 状态 | 进度 |
|-------|------|------|------|------|
| 1 | Foundation | Week 1-2 | 🔵 待开始 | 0% |
| 2 | Multi-Agent | Week 3-4 | ⚪ 未开始 | 0% |
| 3 | Orchestration | Week 5-6 | ⚪ 未开始 | 0% |
...
- [ ] `opctl` CLI 可执行文件
- [ ] 基础命令：`apply`, `get`, `describe`, `delete`, `run`, `logs`, `status`
- [ ] OpenClaw Agent 适配器
- [ ] SQLite 状态存储
- [ ] 单元测试 (覆盖率 > 80%)
- [ ] README 文档
